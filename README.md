...
| 🍏 **macOS** Intel | **mapping only**, not executed - no Intel runner is schedulable on this account. `resolveTarget` is asserted for `darwin-x64` and the asset it names is confirmed to exist in the published release |
